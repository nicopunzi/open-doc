...
* *Disease Type:* By selecting a _DiseaseType_ the first diagnosis list will contain only its related diseases. Second and third list will still contain all diseases. +
 +
_*[.underline]#NB#*: Disease Types can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document. +
_
...
* *Type* (for instance, Drugs or Chemical) +
 +
_*[.underline]#NB#*: Types can be defined by the Administrator._ _Ask to your Administrator how to do it see link:#true14_general_data_general_data[General Data] in this document +
_
...
_*[.underline]#NB#*: Exams, Exam Types and Results as well, can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
* *List*: it is the PriceList that will be used for this bill +
 +
_*[.underline]#NB#*: PriceLists can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
* *TOTAL*: it is the total amount of the bill +
 +
_*[.underline]#NB#*: Prices, or unitary costs, can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
** +
_[.underline]#NB#_**__: Types can be defined by the Administrator. Ask to your Administrator how to do it or read the see link:#true14_general_data_general_data[General Data] in this document.__
...
* *Vaccine.* You can select one vaccine or the value “All vaccines” +
 +
_*[.underline]#NB#*: VaccineTypes and Vaccines can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
* *Ward.* You can select one or more wards between Maternity, Nursery, Surgery, Internal medicine +
 +
_*[.underline]#NB#*: Wards can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document. +
_
...
_*[.underline]#NB#*: AgeTypes (Descriptions) can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
_*[.underline]#NB#*: Wards, AdmissionType and Diagnosis can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
_*[.underline]#NB#*: OperationType and Operations can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
_*[.underline]#NB#*: TreatmentType, DeliveryType and DeliveryResultType can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
_*[.underline]#NB#*: DischargeTypes and Diseases can be defined by the Administrator._ _Ask to your Administrator how to do it or see link:#true14_general_data_general_data[General Data] in this document._
...
If _OPDEXTENDED_ flag is set as YES in the configuration file (ask to your Administrator) the button *[.underline]##O##PD* in the Admission/Patient window will allow you to start an OPD by selecting the related patient first (see link:#true5_2_2_create_a_new_patient_visit_new[Create a new patient visit (New)] for more information)

=== 10.7 Bill ([.underline]##B##ill)

The button *[.underline]##B##ill* in the Admission/Patient window will allow you to start a bill by selecting the related patient first (see link:#true8_2_1_insert_a_new_bill_new_bill[Insert a new bill (New Bill)] for more information)
...
Check function is not mandatory, you can save the therapy plan also without checking the presence of the pharmaceuticals in the hospital (see link:#true8_2_1_9_save_function_save[Save function] below).
...
The Admission Types defined in this functionality will be reflected in the Admission function (see link:#true10_5_1_start_the_admission_of_a_patient_admission[Start the admission of a patient] and link:#true10_5_5_discharge_of_a_patient_admission[Discharge of a patient] in this document).
...
The Discharge Types defined in this functionality will be reflected in the Admission function (see link:#true10_5_1_start_the_admission_of_a_patient_admission[Start the admission of a patient] and link:#true10_5_5_discharge_of_a_patient_admission[Discharge of a patient] in this document).
...
The Delivery Types defined in this functionality will be reflected in the Admission function (see link:#true10_5_4_insertmodify_delivery_data in this document).
...
The Delivery Result Types defined in this functionality will be reflected in the Admission function (see link:#true10_5_4_insertmodify_delivery_data in this document).
...
The Disease Types defined in this functionality will be reflected in the entire application, like in Disease definition or in OPD (see link:#true14_5_disease_disease[Disease] and link:#true5_2_2_create_a_new_patient_visit_new[Create a new patient visit] in this document).
...
The Exam Types defined in this functionality will be reflected in the Laboratory function (see link:#true7_laboratory_laboratory[Laboratory] in this document).
...
The Medical Stock Movement Types defined in this functionality will be reflected in the Pharmaceutical Stock function (see link:#true6_2_2_3_insert_stock_discharging_movement_discharge[Insert stock movement] in this document).
...
The Medical Types defined in this functionality will be reflected in the entire application, like in Pharmacy function and Pharmaceutical Stock Ward (see link:#true6_1_2_1_insert_a_new_pharmaceutical_new[Insert a new pharmaceutical] and link:#true6_3_2_2_search_ward_pharmacy_movements_filter[Search Ward Pharmacy movements] in this document).
...
The Operation Types defined in this functionality will be reflected in the Admission function (see link:#true10_5_3_insertmodify_surgery_data[Insert/modify Surgery data]  in this document).
...
The Pregnant Treatment Types defined in this functionality will be reflected in the Admission function (see link:#true10_5_4_insertmodify_delivery_data in this document).
...
The Other Prices defined in this functionality will be reflected in the Accounting and PriceLists functions (see link:#true8_2_1_insert_a_new_bill_new_bill[Insert a new bill] and link:#true14_9_prices_price_lists[Prices] in this document).
...
The Age Types defined in this functionality will be reflected in the Patient Extended functionality (see link:#true10_4_insert_a_new_patient_extended_new_patient[Insert a new Patient Extended] in this document).
...
The Vaccine Types defined in this functionality will be reflected in the Vaccine function (see link:#true9_vaccines_patient_vaccines[Vaccines] in this document).
...
The Wards defined in this functionality will be reflected in the entire application, like in Admission module, Pharmaceuticals Stock and Pharmaceuticals Stock Ward (see link:#true10_admissionpatient_admissionpatient[Admission/Patient], link:#true6_2_pharmaceutical_stock_pharmaceutical_stock[Pharmaceutical Stock] and link:#true6_3_pharmaceuticals_stock_ward_pharmaceuticals_stock_ward[Pharmaceuticals Stock Ward] in this document).
...
The Diseases defined in this functionality will be reflected in the entire application, like in Admission module and OPD module (see link:#true10_admissionpatient_admissionpatient[Admission/Patient] and link:#true5_outpatient_department_management_opd[Outpatient Department Management] in this document).
...
* *Type*: is the Exam Type (see link:#true14_2_6_exam_types_exam_type[Exam Types] in this document)
* *Code*: you cannot use an already used code; a warning window will appear in case
* *Description*: is the exam name
* *Procedure*: the kind of results for this exam (see link:#true14_6_1_results_results[Results] in this document)
* *Default*: a default value among the result we are going to define (see link:#true14_6_1_results_results[Results] in this document)
...
The difference between *Procedure1* and *Procedure2* will be seen in the Laboratory module (see link:#true7_2_2_create_a_new_laboratory_exam_new[Create a new laboratory exam] and link:#true7_3_3_laboratory_multiple_insert[Laboratory Multiple Insert] in this document)
...
The Operations defined in this functionality will be reflected in the entire application, like in Admission module (see link:#true10_5_3_insertmodify_surgery_data[Insert/modify Surgery data]  in this document).
...
The Vaccines defined in this functionality will be reflected in the entire application, like in Vaccine module (see link:#true9_vaccines_patient_vaccines[Vaccines] in this document).
...
* *Manage Lists*: you can define how many and which pricelist will be available in the application (see link:#true14_9_1_pricelists_manage_lists[Pricelists] in this document)

The *_Prices Browser_* window shows the list of all prices in the selected pricelists; the system automatically creates a price for every Exam (see link:#true14_6_exam_exams[Exam]), Operation (see link:#true14_7_operations_operation[Operations]) and Medical (see link:#true6_1_pharmaceuticals_pharmaceuticals[Pharmaceuticals]) defined in the system, plus other prices defined in Other Prices module (see link:#true14_2_11_other_prices_other_prices[Other Prices])

In order to modify a price just double-click on it and type the new price.

_*[.underline]#NB#*: if a price has been defined as “undefined” (see link:#true14_2_11_other_prices_other_prices[Other Prices]) it will look as 0 – zero and cannot be modified._

_*NB*: Exams, Operations and Medicals prices are automatically created as OPD, IPD, not “daily”, not “undefined”, not “discharge”; see link:#true14_2_11_other_prices_other_prices[Other Prices] for more information._
...
The Lists defined in this functionality will be reflected in the Accounting module (see link:#true8_2_1_insert_a_new_bill_new_bill[Insert a new bill] in this document).
